    ...
    <div className="p-6 bg-gradient-to-b from-purple-700 via-purple-900 to-black text-white min-h-screen">
      ...
      {playlist.songs.length === 0 ? (
        <div className="text-center py-20 bg-black/40 rounded-lg">
          <p className="text-gray-400 text-lg mb-2">No songs in this playlist yet</p>
          <p className="text-gray-500 text-sm mb-4">Add songs to get started!</p>
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[80vh]">
          ...
          {loadingSongs ? (
            ...
            <div className="py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">Upload some songs first!</p>
            </div>
          ) : (
            <>
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                ...
                <div className="flex gap-2">
                  ...
                  <Button onClick={handleAddSongs} disabled={selectedSongs.size === 0 || addingLoading}>
