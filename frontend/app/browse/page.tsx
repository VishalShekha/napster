        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Discover music by genre, mood, and more
            </p>
          </div>
              ...
              {genres.map((genre) => (
                ...
                >
                  <CardContent className="p-4 h-32 flex flex-col justify-between">
                    ...
                    <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-black/20 rounded-full rotate-12">
                      <img
              ...
              {topCharts.map((chart) => (
                ...
                >
                  <CardContent className="p-4">
                    ...
                    <div>
                      <p className="font-medium text-card-foreground truncate mb-1">
                        {chart.title}
                      </p>
